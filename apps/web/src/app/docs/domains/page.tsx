      ...
      <main id="main" className="mx-auto max-w-3xl px-6 pb-24 pt-28">
        ...
        <ul className="mt-10 space-y-4">
          {packs.map((pack) => (
            <li key={pack.id}>
              <Link
                href={`/docs/domains/${pack.id}`}
                className="block rounded-xl border border-white/10 bg-white/[0.02] p-5 transition-colors hover:border-primary/40 hover:bg-white/[0.04]"
              >
